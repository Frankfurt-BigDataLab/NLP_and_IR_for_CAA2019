...
def load_designs():
    ...
    """
    designs = pd.read_sql_table("Designs", "mysql://user:password@localhost:3306/database_name")
...
def load_crro_designs():
    ...
    """
    designs = pd.read_sql_table("designs_crro","mysql://user:password@localhost:3306/database_name")
...
def load_ocre_designs():
    ...
    """
    designs = pd.read_sql_table("designs_ocre","mysql://user:password@localhost:3306/database_name")
    english_designs = designs[["DesignID", "DesignEng"]]
    return english_designs

def load_ocre_designs_obv():
    """
    loads sentences from OCRE database (only obverses) from an SQL table
    """
    designs = pd.read_sql_table("designs_ocre_obv","mysql://user:password@localhost:3306/database_name")
    english_designs = designs[["DesignID", "DesignEng"]]
    return english_designs
